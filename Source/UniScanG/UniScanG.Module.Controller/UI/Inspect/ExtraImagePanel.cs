...
namespace UniScanG.Module.Controller.UI.Inspect
{
    public partial class ExtraImagePanel : UserControl, IInspectExtraPanel
    {
        ...
        public void UpdateVisible()
        {
            ...
            this.Visible = AdditionalSettings.Instance().StripeDefectAlarm.Use;

            double yMax = Math.Min(100, AdditionalSettings.Instance().StripeDefectAlarm.Percent * 1.2);
            ...
            stripLine.IntervalOffset = AdditionalSettings.Instance().StripeDefectAlarm.Percent;
