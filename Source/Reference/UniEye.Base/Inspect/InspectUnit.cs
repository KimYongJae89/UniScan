...
namespace UniEye.Base.Inspect
{
    public class UnitInspectItem
    {
        ...
        InspectOption inspectionOption;
        public InspectOption InspectionOption
        {
        ...
        public UnitInspectItem(AlgorithmInspectParam algorithmInspectParam, InspectionResult inspectionResult, InspectOption inspectionOption = null)
        {
    ...
    public class InspectUnitManager : IEnumerable<InspectUnit>
    {
        ...
        {
            if (this.inspectUnitList.Count == 0)
                return 0;
            return this.inspectUnitList.Max(f => f.GetLoadFactor());
        }
        ...
        public void Run()
        {
            LogHelper.Debug(LoggerType.Inspection, "InspectUnitManager::Run");
        ...
        public void Stop()
        {
            LogHelper.Debug(LoggerType.Inspection, "InspectUnitManager::Stop");
        ...
        public bool IsAlgorithmComplete()
        {
            if (inspectUnitList.Exists(f => f.IsAlgorithmStarted || f.GetQueueCount() > 0))
                return true;
        ...
        {
            LogHelper.Debug(LoggerType.Inspection, "InspectUnitManager::StartInspect");
        ...
        public IEnumerator<InspectUnit> GetEnumerator()
        {
            return this.inspectUnitList.GetEnumerator();
        }
            ...
            while (this.RequestStop == false)
            {
                ...
                if (unitInspectItem.InspectionResult.Judgment != Judgment.Skip)
                {
                    ...
                    finally
                    {
                        ...
                        unitInspectItem.InspectionResult.InspectionEndTime = DateTime.Now;
                    }
                    algorithmStarted.Reset();
                    string debugString = string.Format("InspectUnit::ThreadProc \"{0}\" Inspect End.  {1}[ms]", this.name, sw.ElapsedMilliseconds);
                    LogHelper.Debug(LoggerType.Inspection, debugString);
