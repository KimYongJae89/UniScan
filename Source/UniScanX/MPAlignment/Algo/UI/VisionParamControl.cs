...
namespace UniScanX.MPAlignment.Algo.UI
{
    public partial class VisionParamControl : UserControl, ProbeContainable
    {
        ...
        public Bitmap TargetImage
        {
            ...
            {
                targetImage = value;
        //        patternMatchingParamControl.TargetGroupImage = targetImage;                
        ...
        private MPParamControl brightnessCheckerParamControl;
        ...
        public VisionParamControl()
        {
            ...
            this.brightnessCheckerParamControl = new MPParamControl();
            ...
            this.patternMatchingParamControl.ValueChanged = new AlgorithmValueChangedDelegate(VisionParamControl_ValueChanged);
            ...
            this.binaryCounterParamControl.ValueChanged = new AlgorithmValueChangedDelegate(VisionParamControl_ValueChanged);
            ...
            this.brightnessCheckerParamControl.ValueChanged = new AlgorithmValueChangedDelegate(VisionParamControl_ValueChanged);
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - SetSelectedProbe");
        ...
        private void UpdateData()
        {
            ...
            LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - UpdateData");
            ...
            VisionParamControl_ValueChanged(ValueChangedType.ImageProcessing, null, null, false);
        }
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - EnableBinarizationControls");
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - ShowAlgorithmParamControl");
        ...
        public void VisionParamControl_ValueChanged(ValueChangedType valueChangedType, Algorithm algorithm, AlgorithmParam newParam, bool modified)
        {
            if (onValueUpdate == false)
            {
                LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - VisionParamControl_PositionUpdated");
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm,"VisionParamControl - useHistogramEqualization_CheckedChanged");
...
//            VisionParamControl_ValueChanged(ValueChangedType.ImageProcessing);
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm, "VisionParamControl - useBinarization_CheckedChanged");

            if (selectedProbe == null)
            {
                LogHelper.Error(LoggerType.Algorithm, "VisionParamControl - selectedProbe instance is null.");
                return;
            }
 ...
 //           VisionParamControl_ValueChanged(ValueChangedType.ImageProcessing);
        ...
        {
            LogHelper.Debug(LoggerType.Algorithm, "VisionParamControl - radioSingleThreshold_CheckedChanged");
