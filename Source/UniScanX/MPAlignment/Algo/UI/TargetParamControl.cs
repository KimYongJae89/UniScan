...
using UniScanX.MPAlignment.Algo;
...
namespace UniScanX.MPAlignment.Algo.UI
{
    ...
    public partial class TargetParamControl : UserControl
    {
        ...
        public TargetParamControl()
        {
            ...
            //this.targetImageView.FigureDeleted += targetImageView_FigureDeleted; FigureRemovedDelegate
            this.targetImageView.FigureRemoved += targetImageView_FigureDeleted; 
      ...
      //     this.targetImageView.InspectRequest += targetImageView_InspectRequest;
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - Initialize");
        }

        public void UpdateData(Model model, Target selTarget)
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - UpdateData");
         ...
         //       lblAngle.Text = currentTarget.Region.Angle.ToString(); //zmsong
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - UpdateTargetImage");
        ...
        public void UpdateTargetImageFigure(Target target)
        {
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - UpdateTargetImageFigure");
      ...
      //      target.AppendProbeFigures(targetImageView.WorkingFigures, null);
        ...
        public void UpdateProbeImageFigure()
        {
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - UpdateProbeImageFigure");

            targetImageView.TempFigures.Clear();
            selectedProbes[0].AppendAdditionalFigures(targetImageView.TempFigures);

            RectangleF targetBoundRect = currentTarget.BaseRegion.GetBoundRect();
        ...
        private void UpdateProbeSelector(Target target)
        {
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - UpdateProbeSelector");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - probeList_CellClick");
        ...
        private void SelectProbe(int rowIndex)
        {
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - SelectProbe");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - addProbeButton_Click");
        ...
        { 
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - deleteProbeButton_Click");

     //       targetImageView.Remove(); 
        }
       ...
       //     currentTarget.SetModified();
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - GetDefaultProbeRegion");
            ...
            float centerX = currentTarget.BaseRegion.GetBoundRect().Left + currentTarget.BaseRegion.GetBoundRect().Width / 2;
            float centerY = currentTarget.BaseRegion.GetBoundRect().Top + currentTarget.BaseRegion.GetBoundRect().Height / 2;

            float width = currentTarget.BaseRegion.GetBoundRect().Width / 4;
            float height = currentTarget.BaseRegion.GetBoundRect().Height / 4;
        ...
        private Image2D GetClipImage(RotatedRect clipRegion)
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - GetClipImage");
            Image2D image = Image2D.FromBitmap(ImageHelper.ClipImage((Bitmap)targetImage, clipRegion));
            return image;
        }
        ...
        private void AddVisionProbe(VisionProbe visionProbe)
        {
            if (currentTarget == null)
            {
                LogHelper.Error(LoggerType.Operation, "TargetParamControl - Target is not selected or multi-selected");
                return;
            }
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - GetProbeIndex");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - AddSelectedProbe(Probe probe)");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - ProbeAdded");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - CreateVisionProbe");

            VisionProbe visionProbe = (VisionProbe)ProbeFactory.Create(ProbeType.Vision);
            visionProbe.BaseRegion = inspRegion;
        ...
        private Algorithm CreateAlgorithm(RotatedRect imageRegion)
        {
            ...
            switch(algorithmType)
            {
                case AlgorithmType.PatternMatching:
                    ...
                    var a = patternMatching.GetAlgorithmType();
                    var b = GetClipImage(imageRegion);
                    ...
                    patternMatching.AddPattern( (Image2D)algoImage.ToImageD());
                    break;
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - patternMatchingToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - colorCheckerToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - colorMatchCheckerToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - binaryCounterToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - iOProbeToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - ShowInspResult");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - targetImageView_FigureMoved");
    ...
    //        }
       ...
       //     currentTarget.SetModified();
        ...
        private void targetImageView_FigureCopied(
        ...
        private void targetImageView_FigureSelected(List<Figure> figureList)
        {
            if (currentTarget == null)
                return;
        ...
        private void targetImageView_FigureCreated(Figure figure, CoordTransformer coordTransformer)
        {
            if (currentTarget == null)
                return;
   ...
   //         Probe probe = AddProbe(figure, workingFigures);
    ...
    //        ProbeAdded(new List<Probe>() { probe });
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - brightnessCheckerToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - widthCheckerToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - targetName_TextChanged");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - targetImage_FigureMoved");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - targetImage_FigureSelected");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - daqToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - copyProbeButton_Click");

            if (currentTarget == null)
            {
                LogHelper.Error(LoggerType.Operation, "TargetParamControl - Target is not single selected.");
                return;
            }
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - useInspection_CheckedChanged");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl -  Logic selected");
            foreach (Target target in selectedTargets)
            {
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "ModellerPage - barcodeReadToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - serialBarcodeToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - boltCheckerToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - boltSegmentationToolStripMenuItem_Click");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - blobCheckerToolStripMenuItem_Click");
      ...
      //      curModel.SyncTarget(currentTarget);
        ...
        private void cmbTargetType_TextChanged(object sender, EventArgs e)
        {
            ...
            LogHelper.Debug(LoggerType.Operation, "TargetParamControl - cmbTargetType_TextChanged");
        ...
        {
            LogHelper.Debug(LoggerType.Operation, "VisionParamControl - checkPreview_CheckedChanged");

            if (currentTarget == null)
            {
                LogHelper.Error(LoggerType.Operation, "VisionParamControl - selectedProbe instance is null.");
                return;
            }
