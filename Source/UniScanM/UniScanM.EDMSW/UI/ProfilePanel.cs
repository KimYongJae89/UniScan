...
namespace UniScanM.EDMSW.UI
{
    interface IProfilePanel
    {
        void Initialize();
        void ClearPanel();
        void AddChartDataList(List<DataPoint> chartDataList);
        void DisplayResult(bool whole_X = false);
    }
    public partial class ProfilePanel : UserControl, IMultiLanguageSupport, IProfilePanel
    {
