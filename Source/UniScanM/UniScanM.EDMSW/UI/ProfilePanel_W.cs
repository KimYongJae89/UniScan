...
{
    public partial class ProfilePanel_W : UserControl, IMultiLanguageSupport, IProfilePanel
    {
        ...
        bool isReport;
        DataType_Length dataType;
        List<DataPoint> dataList = new List<DataPoint>();
        List<DataPoint> dataList2 = new List<DataPoint>();

        public DataType_Length DataType { get => dataType; set => dataType = value; }

        public ProfilePanel_W(DataType_Length dataType)
        {
            InitializeComponent();
            this.SuspendLayout();
        ...
        private string GetPanelTypeString()
        {
            ...
            switch (DataType)
            {//DataType_Length
                case DataType_Length.W100:
                    panelTypeStr = "W100 Film Width";
                    break;
                case DataType_Length.W101:
                    panelTypeStr = "W101 Coating Width";
                    break;
                case DataType_Length.W102:
                    panelTypeStr = "W102 Printing Width";
                    break;
                case DataType_Length.L100:
                    panelTypeStr = "L100 Left Length";
                    break;
                case DataType_Length.L200:
                    panelTypeStr = "L200 Right Length";
                    break;
                case DataType_Length.LDIFF:
                    panelTypeStr = "Length Distorion";
                    break;
        ...
        public void Initialize()
        {
            try
            {
                ...
                if (dataType == DataType_Length.LDIFF)
                {
        ...
        public void DisplayResult(bool whole_X=false)
        {
            ...
            lock (dataList)
            {
                ...
                if (dataList.Count() > 0)
                {
                    ...
                    float yRange = dataType != DataType_Length.LDIFF ? setting.YAxisRangeMM : setting.YAxisRangeUM;
