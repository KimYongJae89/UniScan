...
namespace UniScanM.EDMSW.Settings
{
    public class EDMSSettings : UniScanM.Settings.UniScanMSettings
    {
        ...
        #region //8. Calibration
        private float calibration330; //330패턴오프셋
        [LocalizedCategoryAttributeEDMS("8. Calibration "),
        LocalizedDisplayNameAttributeEDMS("Offset 330 sheet (mm)"),
        LocalizedDescriptionAttributeEDMS("Offset 330 sheet (mm)")]
        public float Calibration330 { get => calibration330; set => calibration330 = value; }

        private float calibration440; //330패턴오프셋
        [LocalizedCategoryAttributeEDMS("8. Calibration "),
        LocalizedDisplayNameAttributeEDMS("Offset 440 sheet (mm)"),
        LocalizedDescriptionAttributeEDMS("Offset 440 sheet (mm)")]
        public float Calibration440 {
            get => calibration440;
            set => calibration440 = value;
        }
        ...
        public override void Save(XmlElement xmlElement)
        {
            ...
            //8 calibration
            XmlHelper.SetValue(graphColorElement, "Calibration330", Calibration330.ToString());
            XmlHelper.SetValue(graphColorElement, "Calibration440", Calibration440.ToString());
        ...
        public override void Load(XmlElement xmlElement)
        {
           ...
           XmlElement vibrationGraphElement = xmlElement["Chart"];
            ...
            if (graphColorElement != null)
            {
                ...
                //8 calibration
                Calibration330 = float.Parse(XmlHelper.GetValue(graphColorElement, "Calibration330", "366"));
                Calibration440 = float.Parse(XmlHelper.GetValue(graphColorElement, "Calibration440", "496"));
            }
