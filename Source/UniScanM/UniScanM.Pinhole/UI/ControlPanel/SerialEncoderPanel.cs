...
namespace UniScanM.Pinhole.UI.ControlPanel
{
    public partial class SerialEncoderPanel : UserControl
    {
        ...
        SerialEncoderV105 serialEncoder;
        public SerialEncoderV105 SerialEncoder
        {
            get { return serialEncoder; }
            set { serialEncoder = value; }
        }

        public SerialEncoderPanel(SerialEncoderV105 serialEncoder)
        {
            InitializeComponent();
        ...
        private void ExcuteCommand(string packetString)
        {
            ...
            string[] token = serialEncoder.ExcuteCommand(packetString).Split(',');
            UpdateValue(token);
        ...
        private void dataGridView1_CellValuePushed(object sender, DataGridViewCellValueEventArgs e)
        {
            ...
            switch (e.ColumnIndex)
            {
                case 1:
                    ...
                    token = serialEncoder.ExcuteCommand(en, value).Split(',');
