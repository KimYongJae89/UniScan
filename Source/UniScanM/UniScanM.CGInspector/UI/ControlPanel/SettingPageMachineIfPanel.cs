...
namespace UniScanM.CGInspector.UI.ControlPanel
{
    public partial class SettingPageMachineIfPanel : UserControl
    {
            ...
            if (this.onTask == false)
            {
                Task.Run(() =>            
                {
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        MelsecMachineIfProtocol protocol = (MelsecMachineIfProtocol)SystemManager.Instance().DeviceBox.MachineIf.MachineIfSetting.MachineIfProtocolList.GetProtocol(command);
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            MelsecMachineIfProtocol melsecMachineIfProtocol = (MelsecMachineIfProtocol)machineIf.MachineIfSetting.MachineIfProtocolList.GetProtocol(command).Clone();
