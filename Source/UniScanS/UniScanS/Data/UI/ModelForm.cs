...
namespace UniScanS.Data.UI
{
    ...
    internal partial class ModelForm : Form, IMultiLanguageSupport
    {
        ...
        ModelDescriptionS modelDescription = null;
        ...
        private void SetModelData()
        {
            ...
            thickness.Text = modelDescription.Thickness.ToString();
        ...
        private void GetModelData()
        {
            ...
            modelDescription.Thickness = Convert.ToSingle(thickness.Text);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            switch (modelFormType)
            {
                case ModelFormType.New:
                    ...
                    modelDescription = (ModelDescriptionS)SystemManager.Instance().ModelManager.CreateModelDescription();
                    GetModelData();
                    break;
