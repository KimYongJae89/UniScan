...
;
        ...
        private void TeachPage_Leave(object sender, System.EventArgs e)
        {
            foreach (IVncControl vncButton in vncButtonList)
                vncButton.ExitProcess();

            SystemManager.Instance().InspectRunner.PreExitWaitInspection();
        }

        private void TeachPage_Enter(object sender, System.EventArgs e)
        {
