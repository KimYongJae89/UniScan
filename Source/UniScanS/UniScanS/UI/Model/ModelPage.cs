...
namespace UniScanS.UI.Model
{
    internal partial class ModelPage : UserControl, UniEye.Base.UI.IMainTabPage, IModelListener, IMultiLanguageSupport, ICommListener
    {
        ...
        private void buttonSelect_Click(object sender, EventArgs e)
          {
            ...
            ModelDescriptionS modelDescription = (ModelDescriptionS)modelList.SelectedRows[0].Tag;
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                ModelDescriptionS md = (ModelDescriptionS)dataGridViewRow.Tag;
        ...
        private void RefreshModelList(string searchText = "")
        {
            ...
            int totalModelNum = 0;
            foreach (ModelDescriptionS modelDescription in SystemManager.Instance().ModelManager)
            {
        ...
        private void SelectionChanged()
        {
            ...
            ModelDescriptionS selectedMd = (ModelDescriptionS)modelList.SelectedRows[0].Tag;

            foreach (ModelDescriptionS md in SystemManager.Instance().ModelManager)
            {
        ...
        delegate void CommChangedDelegate();
        public void Connected()
        {
            if (InvokeRequired == true)
            {
                Invoke(new CommChangedDelegate(Connected));
                return;
            }
        ...
        public void Disconnected()
        {
            if (InvokeRequired == true)
            {
                Invoke(new CommChangedDelegate(Disconnected));
                return;
            }
